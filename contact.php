                ...
                <!--Navbar-->
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="about.phpl">พรรค</a>
                            </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 header-info">
                            <h1>
                                <span class="d-block text-primary">บอกเรามาสิ</span>
                                <span class="d-block text-dark" style="font-family: kanit;">เราชอบที่จะฟังคุณ</span>
                            </h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <h2 class="mb-4">มา<span>เริ่มกันเลย</span></h2>

                            <form class="contact-form me-lg-5 pe-lg-3" role="form" method="post" action="contact_db.php">
                                ...
                                <div class="form-floating my-4">
                                    <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="อีเมล" required>

                                    <label for="email">อีเมล</label>
                                </div>

                                <div class="form-floating mb-4">
                                    <textarea id="message" name="message" class="form-control" placeholder="เขียนทิ้งไว้เลย" required style="height: 160px"></textarea>

                                    <label for="message">บอกความคิดเห็นของคุณให้เราฟังหน่อยสิ</label>
                                </div>

                                <div class="col-lg-5 col-6">
                                    <button type="submit" class="form-control">ส่งเลย!</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 ms-auto">
                            <div class="row">
                                ...
                                <div class="col-6 border-top border-end contact-info">
                                    <h6 class="mb-3">สำนักงานของพวกเรา</h6>

                                    <p class="text-muted">ห้องสภานักเรียน, อาคารอนุรักษ์, โรงเรียนเรยีนาเชลีวิทยาลัย</p>
                                </div>

                                <div class="col-6 border-top contact-info">
                                    <h6 class="mb-3">โซเชียลมีเดีย</h6>
